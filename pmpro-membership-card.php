...
function pmpro_membership_card_return_user_name( $pmpro_membership_card_user ) {
	...
	if ( ! empty( $pmpro_membership_card_user->user_firstname ) || ! empty( $pmpro_membership_card_user->user_lastname ) ) {
		$details = trim(
			$pmpro_membership_card_user->user_firstname . ' ' . $pmpro_membership_card_user->user_lastname
		);
	}

	if ( empty( $details ) && ! empty( $pmpro_membership_card_user->display_name ) ) {
		$details = $pmpro_membership_card_user->display_name;
	}
